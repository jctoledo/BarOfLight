...
public class Light {
    ...
    public Light(String ip_address, String mac_address, double temperature, int request_power, int actual_power,
    ...
    @Override
    public int hashCode() {
        return Objects.hash(ip_address, mac_address, request_power, actual_power, temperature,
                rssi, lastSeen, group);
    }
